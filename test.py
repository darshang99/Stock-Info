...
while i == 1:
    ...
    print("1. Gainer stocks")
    print("2. Loser stocks")
...
def get_updates(url,option):#function defination
    ...
    browser.get(url) 
    dropdown = browser.find_element_by_css_selector('#chart-toolbar > div:nth-child(1) > div.M\(0\).D\(ib\).Bdrs\(3px\).C\(\$tertiaryColor\).Fz\(s\).Fw\(500\).O\(n\)\:f\!.Mstart\(15px\).Mstart\(10px\)--tab1024.Mstart\(10px\)--tab768.chartTypeBtn.Pos\(r\) > div')
    ...
    elem = browser.find_element_by_css_selector('#chart-toolbar > div:nth-child(1) > div.D\(ib\).Whs\(nw\).H\(17px\) > ul > li:nth-child(2) > button') #selecting the 5 day change values
    elem.click()
    time.sleep(5)
    screenshot = browser.save_screenshot(stock+'5d.png') 
    elem2 = browser.find_element_by_css_selector('#chart-toolbar > div:nth-child(1) > div.D\(ib\).Whs\(nw\).H\(17px\) > ul > li:nth-child(3) > button') #selecting 1M changes values
    elem2.click()
    time.sleep(5)
    screenshot = browser.save_screenshot(stock+'1M.png')
    elem3 = browser.find_element_by_css_selector('#chart-toolbar > div:nth-child(1) > div.D\(ib\).Whs\(nw\).H\(17px\) > ul > li:nth-child(4)')#selecting 3M changed values
    elem3.click()
    time.sleep(5)
    screenshot = browser.save_screenshot(stock+'3M.png')
    elem4 = browser.find_element_by_css_selector('#chart-toolbar > div:nth-child(1) > div.D\(ib\).Whs\(nw\).H\(17px\) > ul > li:nth-child(5) > button')#selecting 6 month chnaged values
    elem4.click()
    time.sleep(5)
    screenshot = browser.save_screenshot(stock+'6M.png')
    elem5 = browser.find_element_by_css_selector('#chart-toolbar > div:nth-child(1) > div.D\(ib\).Whs\(nw\).H\(17px\) > ul > li:nth-child(7) > button')#selecting 1 year changed values
    elem5.click()
    time.sleep(5)
...
while True:
    stock = input("Enter the stock name you want to see updates on:") #prompting user to enter a stock value
    stock.upper()
    ...
    print("select a option")#asking user to enter the type in which they want to see the data
    print("1.Line")
    print("2.Area")
    print("3.Candle")
    ...
    if choice1 ==1:
        option = '#dropdown-menu > div.Mah\(100\%\).Mih\(100\%\).Ov\(a\).Mah\(67vh\)--touchLs.Mih\(unset\)--touchLs.H\(a\)--touchLs.Ovy\(a\)--touchLs > ul > li.Cur\(p\).C\(\$linkColor\)\:h.Bgc\(\$hoverBgColor\)\:h.chartBtn.Bgc\(\$hoverBgColor\)'
        ...
        option = '#dropdown-menu > div.Mah\(100\%\).Mih\(100\%\).Ov\(a\).Mah\(67vh\)--touchLs.Mih\(unset\)--touchLs.H\(a\)--touchLs.Ovy\(a\)--touchLs > ul > li:nth-child(2) > button'
        docs = get_updates(url4,option)
    elif choice1 ==3:
        option = '#dropdown-menu > div.Mah\(100\%\).Mih\(100\%\).Ov\(a\).Mah\(67vh\)--touchLs.Mih\(unset\)--touchLs.H\(a\)--touchLs.Ovy\(a\)--touchLs > ul > li:nth-child(3) > button'
        docs = get_updates(url4,option)
    elif choice1 ==4:
        option = '#dropdown-menu > div.Mah\(100\%\).Mih\(100\%\).Ov\(a\).Mah\(67vh\)--touchLs.Mih\(unset\)--touchLs.H\(a\)--touchLs.Ovy\(a\)--touchLs > ul > li:nth-child(4) > button'
        docs = get_updates(url4,option)
    elif choice1 ==5:
        option = '#dropdown-menu > div.Mah\(100\%\).Mih\(100\%\).Ov\(a\).Mah\(67vh\)--touchLs.Mih\(unset\)--touchLs.H\(a\)--touchLs.Ovy\(a\)--touchLs > ul > li:nth-child(5) > button'
        docs = get_updates(url4,option)
    elif choice1 ==6:
        option = '#dropdown-menu > div.Mah\(100\%\).Mih\(100\%\).Ov\(a\).Mah\(67vh\)--touchLs.Mih\(unset\)--touchLs.H\(a\)--touchLs.Ovy\(a\)--touchLs > ul > li:nth-child(6) > button'
        docs = get_updates(url4,option)
